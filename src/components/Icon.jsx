...
const P = {
  ...
  fish: '<path d="M7 12c2-3 5-4.5 8.5-4.5S21 9.5 21 12s-2 4.5-5.5 4.5S9 15 7 12z"/><path d="M7 12 3 9.5v5z"/><circle cx="10" cy="11" r=".7" fill="currentColor" stroke="none"/>',
  clam: '<path d="M3.5 14a8.5 5.5 0 0 1 17 0z"/><path d="M12 8.5V14M8 9.6 9.2 14M16 9.6 14.8 14"/>',
  potato: '<ellipse cx="12" cy="12.5" rx="7.2" ry="5.4"/><path d="M9.5 11.3v.02M12.7 13.3v.02M14.6 10.7v.02"/>',
  carrot: '<path d="M14.6 9.2 8.2 18.3a1.5 1.5 0 0 1-2.6-1.5L12 7.6z"/><path d="M12 7.6c.6-1.4 1.8-2 3-1.6M14.6 9.2c1.4-.5 2.2.3 2.6 1.5M13.3 8.1c.1-1.4.9-2.2 2-2.5"/>',
  cabbage: '<circle cx="12" cy="12" r="7.3"/><path d="M12 4.7v14.6M8.2 5.6c-1 4-1 8.8 0 12.8M15.8 5.6c1 4 1 8.8 0 12.8"/>',
  radish: '<path d="M13.8 6c1.9 1.6 2.6 4.6 1.1 8.3-1.2 3-3.4 4.7-5.3 3.9s-2.4-3.7-1.2-6.7C9.9 8 11.9 4.4 13.8 6z"/><path d="M13.8 6c.4-1.3 1.3-2 2.5-2M13.8 6c-.4-1.2-.1-2.2.6-3"/>',
  mushroom: '<path d="M5 11.2a7 7 0 0 1 14 0z"/><path d="M9.8 11.2v4.4a2.2 2.2 0 0 0 4.4 0v-4.4"/>',
  pepper: '<path d="M9 8.5c-1.6 2.2-1 6 1.6 8s6.4 1.4 7.4-1.2c-3 .6-5.6-.9-6.7-3.4S10.6 7.3 9 8.5z"/><path d="M9 8.5c.2-1.5 1.1-2.4 2.3-2.5M9 8.5c-1 .1-2-.4-2.3-1.6"/>',
  sprout: '<path d="M9.5 19.5V9.5M14.5 19.5V9.5"/><path d="M9.5 9.5C8 9.5 7 8.6 7 7.2 7 6 8.2 5.2 9.5 5.6M14.5 9.5c1.5 0 2.5-.9 2.5-2.3 0-1.2-1.2-2-2.5-1.6"/>',
  sack: '<path d="M8 6.5h8l-.8 12a1.2 1.2 0 0 1-1.2 1.1H10a1.2 1.2 0 0 1-1.2-1.1z"/><path d="M8.2 6.5C8.2 4.6 9.6 4 12 4s3.8.6 3.8 2.5"/><path d="M9.6 13h4.8"/>',
  tofu: '<path d="M4.5 8.5 12 5l7.5 3.5L12 12z"/><path d="M4.5 8.5v7L12 19v-7M19.5 8.5v7L12 19"/>',
  noodle: '<circle cx="12" cy="12" r="7.3"/><path d="M7.5 9.5c2.5 1 6.5 1 9 0M6.8 12c3 1.2 7.4 1.2 10.4 0M7.5 14.5c2.5 1 6.5 1 9 0"/>',
  cheese: '<path d="M3.5 12.5 16 7c2.2 0 4 1.6 4.5 3.8L4 15.5z"/><circle cx="9" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="14" cy="11.6" r=".8" fill="currentColor" stroke="none"/>',
  milk: '<path d="M7.5 8 12 4.2 16.5 8v10.5a1 1 0 0 1-1 1h-7a1 1 0 0 1-1-1z"/><path d="M7.5 8h9"/><path d="M10 12.5h4v3.5h-4z"/>',
